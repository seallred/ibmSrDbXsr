-- Total file attachments per Service Request
select src_tran_id, src_appl, src_node, count(*)
  from xsr.pmr_attachment
 where date(create_datetime) >= '2011-01-01'
group by src_tran_id, src_appl, src_node
with ur;


-- File attachments per day per Service Request

-- Total file attachments per repository
